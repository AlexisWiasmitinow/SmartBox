...
#define CYBLE_SMARTBOX_SERVICE_INDEX   (0x00u) /* Index of SmartBox service in the cyBle_customs array */
#define CYBLE_SMARTBOX_ALERT_CHAR_INDEX   (0x00u) /* Index of Alert characteristic */
#define CYBLE_SMARTBOX_ALERT_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CYBLE_SMARTBOX_LEVEL_CHAR_INDEX   (0x01u) /* Index of Level characteristic */
#define CYBLE_SMARTBOX_LEVEL_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */


#define CYBLE_SMARTBOX_SERVICE_HANDLE   (0x0010u) /* Handle of SmartBox service */
#define CYBLE_SMARTBOX_ALERT_DECL_HANDLE   (0x0011u) /* Handle of Alert characteristic declaration */
#define CYBLE_SMARTBOX_ALERT_CHAR_HANDLE   (0x0012u) /* Handle of Alert characteristic */
#define CYBLE_SMARTBOX_ALERT_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0013u) /* Handle of Characteristic User Description descriptor */
#define CYBLE_SMARTBOX_LEVEL_DECL_HANDLE   (0x0014u) /* Handle of Level characteristic declaration */
#define CYBLE_SMARTBOX_LEVEL_CHAR_HANDLE   (0x0015u) /* Handle of Level characteristic */
#define CYBLE_SMARTBOX_LEVEL_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0016u) /* Handle of Characteristic User Description descriptor */
