// ======================================================================
// SmartBox.v generated from TopDesign.cysch
// 06/27/2017 at 10:39
...
`ifdef WARP
`define CY_BLK_DIR "E:\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\or_v1_0"
`include "E:\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\or_v1_0\or_v1_0.v"
`else
`define CY_BLK_DIR "E:\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\or_v1_0"
`include "E:\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\or_v1_0\or_v1_0.v"
`endif
...
module BLE_v3_30_0 (
	...
	cy_clock_v1_0
		#(.id("4e072eca-35f2-4303-a24d-7e0d6f0149bf/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
`ifdef WARP
`define CY_BLK_DIR "E:\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\ZeroTerminal"
`include "E:\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\ZeroTerminal\ZeroTerminal.v"
`else
`define CY_BLK_DIR "E:\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\ZeroTerminal"
`include "E:\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\ZeroTerminal\ZeroTerminal.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "E:\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_analog_virtualmux_v1_0"
`include "E:\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_analog_virtualmux_v1_0\cy_analog_virtualmux_v1_0.v"
`else
`define CY_BLK_DIR "E:\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_analog_virtualmux_v1_0"
`include "E:\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_analog_virtualmux_v1_0\cy_analog_virtualmux_v1_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "E:\PSoC Creator\4.1\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\Bus_Connect_v2_40"
`include "E:\PSoC Creator\4.1\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\Bus_Connect_v2_40\Bus_Connect_v2_40.v"
`else
`define CY_BLK_DIR "E:\PSoC Creator\4.1\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\Bus_Connect_v2_40"
`include "E:\PSoC Creator\4.1\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\Bus_Connect_v2_40\Bus_Connect_v2_40.v"
`endif
...
module ADC_SAR_SEQ_P4_v2_40_1 (
	...
	cy_clock_v1_0
		#(.id("1180c995-8792-4458-b164-1dce924368a9/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
...
`ifdef WARP
`define CY_BLK_DIR "E:\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\and_v1_0"
`include "E:\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\and_v1_0\and_v1_0.v"
`else
`define CY_BLK_DIR "E:\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\and_v1_0"
`include "E:\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\and_v1_0\and_v1_0.v"
`endif
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("f043c520-de76-4e3c-961c-db3e3dbf63d0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin_LED_B_net;
	wire [0:0] tmpFB_0__Pin_LED_B_net;
	wire [0:0] tmpIO_0__Pin_LED_B_net;
	wire [0:0] tmpINTERRUPT_0__Pin_LED_B_net;
	electrical [0:0] tmpSIOVREF__Pin_LED_B_net;

	cy_psoc3_pins_v1_10
		#(.id("9b67ec65-bf5a-4e64-a767-9db040b7b1ad"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_LED_B
		 (.oe(tmpOE__Pin_LED_B_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_LED_B_net[0:0]}),
		  .io({tmpIO_0__Pin_LED_B_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_LED_B_net),
		  .interrupt({tmpINTERRUPT_0__Pin_LED_B_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_LED_B_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    BLE_v3_30_0 BLE_1 (
        .clk(Net_4),
        .pa_en(Net_5));

	wire [0:0] tmpOE__Pin_LED_Ext_net;
	wire [0:0] tmpFB_0__Pin_LED_Ext_net;
	wire [0:0] tmpIO_0__Pin_LED_Ext_net;
	wire [0:0] tmpINTERRUPT_0__Pin_LED_Ext_net;
	electrical [0:0] tmpSIOVREF__Pin_LED_Ext_net;

	cy_psoc3_pins_v1_10
		#(.id("c98c20c4-1580-4b50-88cb-6df04ec8fe01"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_LED_Ext
		 (.oe(tmpOE__Pin_LED_Ext_net),
		  .y({Net_119}),
		  .fb({tmpFB_0__Pin_LED_Ext_net[0:0]}),
		  .io({tmpIO_0__Pin_LED_Ext_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_LED_Ext_net),
		  .interrupt({tmpINTERRUPT_0__Pin_LED_Ext_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_LED_Ext_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("1386be0b-f619-42f2-83a4-663751734afe"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    PWM_v3_30_2 Blinker (
        ...
        .ph1(Net_128),
        .ph2(Net_129));
    defparam Blinker.Resolution = 16;
    ...
    assign Net_142 = Net_141 & Net_176;

    assign Net_143 = 1'h0;


	cy_clock_v1_0
		#(.id("7cef92fe-02d5-4209-afb8-20da660cc2df"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("15384615384.6154"),
		  .is_direct(0),
		  .is_digital(0))
		Clock_1
		 (.clock_out(Net_117));
	...
	wire [0:0] tmpOE__Pin_Beep_Enable_net;
	wire [0:0] tmpFB_0__Pin_Beep_Enable_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Beep_Enable_net;
	electrical [0:0] tmpSIOVREF__Pin_Beep_Enable_net;

	cy_psoc3_pins_v1_10
		#(.id("69c592cc-17ce-4c15-87ce-9cf324f46f9d"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Beep_Enable
		 (.oe(tmpOE__Pin_Beep_Enable_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Beep_Enable_net[0:0]}),
		  .io({Net_176}),
		  .siovref(tmpSIOVREF__Pin_Beep_Enable_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Beep_Enable_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Beep_Enable_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
